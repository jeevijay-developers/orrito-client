      ...
      <div className="absolute inset-0 flex items-center justify-center text-center text-white">
        <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <h1 className="text-2xl sm:text-4xl md:text-5xl lg:text-6xl xl:text-7xl font-bold mb-4 sm:mb-6 leading-tight">
            Lighting the Future
            <span className="block text-orange-400 mt-1 sm:mt-2">One Solution at a Time</span>
          </h1>
          <p className="text-sm sm:text-base md:text-lg lg:text-xl mb-6 sm:mb-8 max-w-2xl md:max-w-3xl mx-auto text-gray-200 leading-relaxed px-2 sm:px-0">
            Transform any space with our comprehensive range of intelligent lighting and electrical solutions designed for modern living and working environments
          </p>
          <div className="flex flex-col sm:flex-row gap-3 sm:gap-4 justify-center px-4 sm:px-0">
            <button className="bg-orange-500 hover:bg-orange-600 text-white px-6 py-3 sm:px-8 sm:py-4 rounded-lg text-base sm:text-lg font-semibold transition-all duration-200 transform hover:scale-105 shadow-lg">
              Explore Solutions
            </button>
