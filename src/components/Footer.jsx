      ...
      <div className="max-w-7xl mx-auto flex flex-wrap md:flex-nowrap justify-between gap-y-8 md:gap-y-0 md:gap-x-10">
        ...
        <div className="flex-1 min-w-[230px] mr-16">
          ...
          <div className="mt-4">
            ...
            <p className="text-gray-700">Tel No: 07480 - 49398</p>
            <p className="text-gray-700">Toll Free No: 1800-889-4722</p>
        ...
        <div className="flex-1 min-w-[220px]">
          ...
          <p className="text-gray-700 mb-2">
            ...
            <a href="mailto:support@oritto.com" className="text-gray-500 hover:underline">
              support@oritto.com
            </a>
          </p>
          <p className="text-gray-700 mb-1">
            Sales Enquiry:{' '}
            <a href="mailto:sales@oritto.com" className="text-gray-500 hover:underline">
              sales@oritto.com
            </a>
          </p>
          <p className="text-gray-700 mb-1">
            Distributor/Dealership & Investor Relations:{' '}
            <a href="mailto:info@oritto.com" className="text-gray-500 hover:underline">
              info@oritto.com
            </a>
          </p>
          <p className="text-gray-700 mb-4">
            Exports Enquiry:{' '}
            <a href="mailto:exports@oritto.com" className="text-gray-500 hover:underline">
              exports@oritto.com
            </a>
          </p>
