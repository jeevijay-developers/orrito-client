      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex justify-end items-center h-12">
          ...
          <div className="flex items-center space-x-4">
            ...
            <Link href="https://wa.me/9999971796" target="_blank" className="cursor-pointer bg-[#25D366] hover:bg-[#1ebe57] text-white px-4 py-2 rounded-lg text-sm font-medium transition-colors duration-200 flex items-center gap-2">
