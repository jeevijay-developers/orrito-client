...
const TopBar = () => {
  ...
  return (
    <nav className="bg-gradient-to-r from-[#e7333e] to-[#ee6339] w-full z-50">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex justify-end items-center h-8">
          ...
          <div className="flex items-center space-x-4">
            ...
            className=" cursor-pointer bg-white border border-[#b8b2b2] text-[#f54900] hover:bg-orange-50 px-4 py-1 rounded-sm text-[10px] font-medium transition-colors duration-200">
              Enquiry
            </button>
